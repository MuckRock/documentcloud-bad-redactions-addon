...
class BadRedactions(AddOn):
    ...
    def main(self):
        ...
        self.client.session.headers.update({'User-Agent': 'Bad Redactions Add-On'})
            ...
            for document in self.get_documents():
                ...
                try:
                    ...
                    self.send_mail(
                        ...
                        ' the Document Compression Add-On: ' 
                        'https://www.documentcloud.org/add-ons/MuckRock/compress-addon/'
